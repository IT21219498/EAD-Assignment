...
const Dashboard = () => {
  ...
  const adminCards = [
    ...
    image: 'https://wareiq-prelogin.s3.ap-south-1.amazonaws.com/wp-content/uploads/2023/08/28192525/all-in-one-order-management-1124x632.jpeg', 
link: '/OrderManagement',
    },
    {
      ...
      image: 'https://business.adobe.com/blog/basics/media_1df3e3d5a2396474f8f90ab0f72f9dd55cb9233bd.png?width=750&format=png&optimize=medium', 
      link: '/ConfirmOrder',
    },
    {
      ...
      image: 'https://www.marketing91.com/wp-content/uploads/2015/06/What-is-product-management.jpg', 
      link: '/Products',
    },
    {
      ...
      image: 'https://cashflowinventory.com/blog/wp-content/uploads/2023/02/inventory-analysis.webp', 
      link: '/Inventory',
    },
    {
      id: 'vendorManagement',
      ...
      image: 'https://media.licdn.com/dms/image/D4D12AQGj5-nuernKvA/article-cover_image-shrink_720_1280/0/1694788197905?e=2147483647&v=beta&t=7QXmnSzxNIfbZ8XHEvJ3EgtU2CAZ59Cg-9kIJ4rUbeQ', 
      link: '/Vendor',
    },
    {
      ...
      image: 'https://www.freshbooks.com/wp-content/uploads/2021/09/account-management-software.jpg', 
      link: '/PendingUsers',
    },
    {
      ...
      image: 'https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcRM_LdcQ3l_T24DuyoDgmWJPJo5Kg59lyI0jA&s', 
  ...
  const csrCards = [
    {
      ...
      image: 'https://www.smartsheet.com/sites/default/files/ic-og-CustomerOrderManagement-FacebookLinkedIn.jpg', 
    ...
    },
    {
      ...
      image: 'https://t4.ftcdn.net/jpg/07/19/82/87/360_F_719828772_iQ5gIUAmuyGnTt6SmTfnTBXYNGqkt9uN.jpg', 
      link: '/CustomerActivation',
    },
    {
      ...
      image: 'https://png.pngtree.com/thumb_back/fh260/background/20220430/pngtree-woman-using-a-labtop-computer-background-business-laptop-working-at-home-photo-image_27847524.jpg', 
  ...
  return (
    <div className="container mt-5">
      ...
      {cardsToDisplay.length > 0 ? (
        ...
        <p className="text-center">No dashboard items available for your role.</p>
      )}
    </div>
  );
};
